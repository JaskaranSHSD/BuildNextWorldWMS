    ...
    b.querySelectorAll("[pb-form]").forEach(function (e, i) {
        ...
        e.onsubmit = function (fe) {
            ...
            $.ajax({
                ...
                if (target == 'modal') {
                    createModal('<img src="/internal/images/buildnextworld-white.png" style="width: 113px;padding: 7px;" >', data);
                }
                else {
                    $("#" + target).html(data);
                }
...
function pre() {
    var html = '<div id="asyn" class="synchronize"><img src="/internal/cdn/svg/synchronize.svg"  /></div>';
    $('body').append(html);
    $("#asyn").addClass("open");
}
function post() {
...
$('input[type=pb-datetime]').inputmask("mm/dd/yyyy");
